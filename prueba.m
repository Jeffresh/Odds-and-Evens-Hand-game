...
% Last Modified by GUIDE v2.5 14-Jun-2018 14:58:14
...
a=handles.a;
canales=handles.canales;
num_bits=handles.num_bits;
ventana=handles.ventana;
save('config.mat','Fs','tiempo','a','canales','num_bits','ventana');
...
handles.tiempo = str2double(get(hObject,'String'));
guidata(hObject, handles);
...
handles.canales = str2double(get(hObject,'String'));
guidata(hObject, handles);
...
handles.num_bits = str2double(get(hObject,'String'));
guidata(hObject, handles);
...
handles.ventana = get(hObject,'String');
guidata(hObject, handles);
